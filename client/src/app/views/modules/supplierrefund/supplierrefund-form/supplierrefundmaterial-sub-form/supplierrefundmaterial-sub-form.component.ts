...
@Component({
  selector: 'app-supplierrefundmaterial-sub-form',
  templateUrl: './supplierrefundmaterial-sub-form.component.html',
  styleUrls: ['./supplierrefundmaterial-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SupplierrefundmaterialSubFormComponent),
      multi: true
    }, {
...
export class SupplierrefundmaterialSubFormComponent extends AbstractSubFormComponent<Supplierrefundmaterial> implements OnInit{
