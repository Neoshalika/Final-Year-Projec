...
@Component({
  selector: 'app-supplierreturnmaterial-sub-form',
  templateUrl: './supplierreturnmaterial-sub-form.component.html',
  styleUrls: ['./supplierreturnmaterial-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SupplierreturnmaterialSubFormComponent),
      multi: true
    }, {
...
export class SupplierreturnmaterialSubFormComponent extends AbstractSubFormComponent<Supplierreturnmaterial> implements OnInit{
