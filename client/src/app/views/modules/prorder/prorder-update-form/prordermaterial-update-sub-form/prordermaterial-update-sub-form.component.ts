...
@Component({
  selector: 'app-prordermaterial-update-sub-form',
  templateUrl: './prordermaterial-update-sub-form.component.html',
  styleUrls: ['./prordermaterial-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => PrordermaterialUpdateSubFormComponent),
      multi: true
    }, {
...
export class PrordermaterialUpdateSubFormComponent extends AbstractSubFormComponent<Prordermaterial> implements OnInit{
