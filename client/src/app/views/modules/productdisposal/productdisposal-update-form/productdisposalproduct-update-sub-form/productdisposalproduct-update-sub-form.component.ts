...
@Component({
  selector: 'app-productdisposalproduct-update-sub-form',
  templateUrl: './productdisposalproduct-update-sub-form.component.html',
  styleUrls: ['./productdisposalproduct-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ProductdisposalproductUpdateSubFormComponent),
      multi: true
    }, {
...
export class ProductdisposalproductUpdateSubFormComponent extends AbstractSubFormComponent<Productdisposalproduct> implements OnInit{
