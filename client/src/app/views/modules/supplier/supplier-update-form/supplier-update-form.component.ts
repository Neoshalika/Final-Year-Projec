...
export class SupplierUpdateFormComponent extends AbstractComponent implements OnInit {
  ...
  setValues(): void{
    ...
    if (this.materialcategoriesField.pristine) {
      this.materialcategoriesField.setValue(this.supplier.materialcategoryList);
    }
  ...
  async submit(): Promise<void> {
    ...
    newsupplier.materialcategoryList = this.materialcategoriesField.value;
