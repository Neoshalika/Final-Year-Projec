...
export class ProductTableComponent extends AbstractComponent implements OnInit {
  ...
  unitpriceField = new FormControl();
  ...
  async loadData(): Promise<any> {
    ...
    pageRequest.addSearchCriteria('unitprice', this.unitpriceField.value);
  ...
  setDisplayedColumns(): void{
    this.displayedColumns = ['code', 'name', 'productstatus', 'photo', 'qty', 'unitprice', 'rpqty'];
