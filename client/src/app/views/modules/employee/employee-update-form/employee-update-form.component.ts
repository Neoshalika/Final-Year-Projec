...
export class EmployeeUpdateFormComponent extends AbstractComponent implements OnInit {
  ...
  onChangeDesignation(): void{
    if (this.designationField.value === 5){
      ...
      this.daysalaryField.setValue(this.employee.daysalary);
    }
  }
  ...
  setValues(): void{
    ...
    if (this.etfnoField.pristine) {
      this.etfnoField.setValue(this.employee.etfno);
    }
    if (this.daysalaryField.pristine) {
      this.daysalaryField.setValue(this.employee.daysalary);
    }
  ...
  async submit(): Promise<void> {
    ...
    newemployee.etfno = this.etfnoField.value;
    newemployee.daysalary = this.daysalaryField.value;
