...
@Component({
  selector: 'app-prmaterialreturnmaterial-update-sub-form',
  templateUrl: './prmaterialreturnmaterial-update-sub-form.component.html',
  styleUrls: ['./prmaterialreturnmaterial-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => PrmaterialreturnmaterialUpdateSubFormComponent),
      multi: true
    }, {
...
export class PrmaterialreturnmaterialUpdateSubFormComponent extends AbstractSubFormComponent<Prmaterialreturnmaterial> implements OnInit{
