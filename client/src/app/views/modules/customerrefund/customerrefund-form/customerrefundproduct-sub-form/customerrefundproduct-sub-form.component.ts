...
@Component({
  selector: 'app-customerrefundproduct-sub-form',
  templateUrl: './customerrefundproduct-sub-form.component.html',
  styleUrls: ['./customerrefundproduct-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CustomerrefundproductSubFormComponent),
      multi: true
    }, {
...
export class CustomerrefundproductSubFormComponent extends AbstractSubFormComponent<Customerrefundproduct> implements OnInit{
  ...
  getDeleteConfirmMessage(customerrefundproduct: Customerrefundproduct): string {
    return 'Are you sure to remove \u201C ' + customerrefundproduct.qty + ' \u201D from customer refund product?';
  }

  getUpdateConfirmMessage(customerrefundproduct: Customerrefundproduct): string {
    if (this.isFormEmpty){
      return 'Are you sure to update \u201C\u00A0' + customerrefundproduct.qty + '\u00A0\u201D\u00A0?';
    }

    return 'Are you sure to update \u201C\u00A0' + customerrefundproduct.qty + '\u00A0\u201D and discard existing form data\u00A0?';
  }
