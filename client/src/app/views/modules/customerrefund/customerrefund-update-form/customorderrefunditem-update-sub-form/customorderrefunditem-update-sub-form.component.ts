...
@Component({
  selector: 'app-customorderrefunditem-update-sub-form',
  templateUrl: './customorderrefunditem-update-sub-form.component.html',
  styleUrls: ['./customorderrefunditem-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CustomorderrefunditemUpdateSubFormComponent),
      multi: true
    }, {
...
export class CustomorderrefunditemUpdateSubFormComponent extends AbstractSubFormComponent<Customorderrefunditem> implements OnInit{
