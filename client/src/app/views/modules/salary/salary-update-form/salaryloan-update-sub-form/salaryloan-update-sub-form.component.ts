...
@Component({
  selector: 'app-salaryloan-update-sub-form',
  templateUrl: './salaryloan-update-sub-form.component.html',
  styleUrls: ['./salaryloan-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SalaryloanUpdateSubFormComponent),
      multi: true
    }, {
...
export class SalaryloanUpdateSubFormComponent extends AbstractSubFormComponent<Salaryloan> implements OnInit{
