...
@Component({
  selector: 'app-deduction-update-sub-form',
  templateUrl: './deduction-update-sub-form.component.html',
  styleUrls: ['./deduction-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DeductionUpdateSubFormComponent),
      multi: true
    }, {
...
export class DeductionUpdateSubFormComponent extends AbstractSubFormComponent<Deduction> implements OnInit{
