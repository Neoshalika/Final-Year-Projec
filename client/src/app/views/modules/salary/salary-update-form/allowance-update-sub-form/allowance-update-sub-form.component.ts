...
@Component({
  selector: 'app-allowance-update-sub-form',
  templateUrl: './allowance-update-sub-form.component.html',
  styleUrls: ['./allowance-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AllowanceUpdateSubFormComponent),
      multi: true
    }, {
...
export class AllowanceUpdateSubFormComponent extends AbstractSubFormComponent<Allowance> implements OnInit{
