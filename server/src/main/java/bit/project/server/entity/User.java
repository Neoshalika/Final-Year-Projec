...
public class User{
    ...
    @ManyToOne
    @JsonIgnoreProperties({"creator","tocreation","civilstatus","fullname","dobirth","gender","nic","etfno","daysalary","mobile","land","email","address","designation","dorecruit","employeestatus","description"})
